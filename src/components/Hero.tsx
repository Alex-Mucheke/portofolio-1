        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <motion.a
                href="https://docs.google.com/document/d/1Dg0wYOJZsGvLl9nSiuBFsO16PXk5VGFO/edit?usp=drive_link&ouid=116967796453523479991&rtpof=true&sd=true"
                target="_blank"
          ...
          >
            <div className="relative w-full h-96 flex items-center justify-center">
              ...
              <motion.div
                className="w-64 h-80 bg-surface-800/50 backdrop-blur-sm border border-surface-700 rounded-2xl p-6 shadow-2xl overflow-hidden"
                animate={{ y: [0, -5, 0] }}
                transition={{ duration: 4, repeat: Infinity }}
              >
                <div className="w-full h-40 bg-surface-900 rounded-lg mb-4 overflow-hidden">
                  <img
                    src="me.png"
